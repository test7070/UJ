...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = "rc2_s";
            var aPop = new Array(['txtCno', '', 'acomp', 'noa,acomp', 'txtCno,txtAcomp', 'acomp_b.aspx'], ['txtTggno', '', 'tgg', 'noa,comp,nick', 'txtTggno,txtTgg', 'tgg_b.aspx']);
            ...
            function q_gfPost() {
                ...
                //q_cmbParse("cmbStype", '@全部,'+q_getPara('rc2.stype'));
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("cno", t_cno) + q_sqlPara2("datea", t_bdate, t_edate) 
                + q_sqlPara2("mon", t_mon) + q_sqlPara2("tggno", t_tggno) + q_sqlPara2("invono", t_invono) 
                + q_sqlPara2("accno", t_accno)+ q_sqlPara2("typea", t_typea) ;//+ q_sqlPara2("stype", t_stype)
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<!--<tr class='seek_tr'>
	                <td class='seek'  style="width:20%;"><a id='lblStype'>類別</a></td>
