<html xmlns="http://www.w3.org/1999/xhtml"> 
	<head>
		...
		<script type="text/javascript">
            var q_name = 'ordes', t_bbsTag = 'tbbs', t_content = " ", afilter = [], bbsKey = ['noa'], as;
		...
		<div  id="dbbs"  >
			<table id="tbbs" class='tbbs'  border="2"  cellpadding='2' cellspacing='1' style='width:100%'  >
				<tr style='color:White; background:#003366;' >
					...
					<td align="center" style="width:8%;" class=""><a id='lblOdate'> </a></td>
					<td align="center" style="width:8%;" class=""><a id='lblProductno'> </a></td>
					<td align="center" style="width:8%;" class=""><a id='lblProduct'> </a></td>
					<td align="center" style="width:8%;" class=""><a id='lblUnit'> </a></td>
					<td align="center" style="width:8%;" class=""><a id='lblMount'> </a></td>
					<!--
				...
				<tr  style='background:#cad3ff;'>
					...
					<td><input class="txt"  id="txtMount.*" type="text" style="width:98%;" /></td>
					<!--
