		...
		<div id='dbbs' class='dbbs'>
            <table id="tbbs" class='tbbs'>
                <tr style='color:white; background:#003366;' >
					<td align="center" style="width:20px;"><input type="checkbox" id="checkAllCheckbox"/></td>
					<td align="center" style="width:20px;"> </td>
					<td align="center" style="width:160px;"><a id='lblProductno_uj'>料號</a></td>
					<td align="center" style="width:200px;"><a id='lblProduct_uj'>品名</a> </td>
					<td align="center" style="width:75px;"><a id='lblDime_uj'>採購量<BR>(Kg)</a></td>
					<td align="center" style="width:75px;"><a id='lblWeight_uj'>採購量<BR>(M)</a></td>
					<td align="center" style="width:75px;"><a id='lblMount_uj'>採購量<BR>(支)</a></td>
					<td align="center" style="width:60px;"><a id='lblUnit_uj'>採購<BR>單位</a></td>
					<td align="center" style="width:60px;"><a id='lblUnit2_uj'>計價<BR>單位</a></td>
					<td align="center" style="width:80px;"><a id='lblPrice'> </a></td>
					<td align="center" style="width:180px;"><a id='lblNoa'> </a><BR><a id='lblMemo'> </a></td>
				</tr>
				<tr  style='background:#cad3ff;'>
					...
					<td><input class="txt" id="txtUnit2.*" type="text" style="width:95%;"/></td>
