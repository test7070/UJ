	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_gfPost() {
				...
				q_mask(bbmMask);
				$('#txtBdate').focus();
				q_cmbParse("cmbTypea", '@全部,'+q_getPara('worka.typea'));
			}
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek" border="1" cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek' style="width:20%;"><a id='lblMechno'>機台號碼</a></td>
					<td><input class="txt" id="txtMechno" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
				<!--<tr class='seek_tr'>
					<td class='seek' style="width:20%;"><a id='lblProductno_uj'>料號</a></td>
